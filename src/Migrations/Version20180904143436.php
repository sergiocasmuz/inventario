 ...
 */
final class Version20180904143436 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE elineas ADD articulo VARCHAR(255) NOT NULL, ADD marca VARCHAR(255) NOT NULL, ADD modelo VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE elineas DROP articulo, DROP marca, DROP modelo');
